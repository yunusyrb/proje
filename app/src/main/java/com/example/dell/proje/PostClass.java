...
public class PostClass {
	...
	public  String httpPost(String url, String method,List<NameValuePair> params,int time) {
		...
		//params:post edilecek veriler değişkkenler
		//time: sunucudan cevap gelmezse kaç sn sonra uygulama donmadan postun iptal edilece�i
        try {
        ...
        return veri_string; // Aldığımızz cevabin string halini geri donuyoruz
